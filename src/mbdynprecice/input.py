...
class ElementsBlock(Block):
    ...
    # orientation matrix
    __force_coupling_str = '{flabel}, external structural, socket, create, yes, path, "{sname}.sock", no signal, sleep time, 0.01, coupling, tight, orientation, none, accelerations, no, {num},{nodes}'
